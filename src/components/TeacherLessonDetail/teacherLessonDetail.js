...
const TeacherLessonDetail = () => {
  ...
  const _submitFeedback = async () => {
    ...
    if (!state?.rate || state.rate.length == 0) {
            ...
            <div>
              <div className="">
                ...
                <div className="rating justify-content-end">
                  ...
                  <label name="rating" htmlFor="rating-5" value={5} onClick={(e) => updateState('rate', parseInt(e.target.getAttribute("value")))}></label>
                  <input type="radio" name="rating" id="rating-4" />
                  <label name="rating" htmlFor="rating-4" value={4} onClick={(e) => updateState('rate', parseInt(e.target.getAttribute("value")))}></label>
                  <input type="radio" name="rating" id="rating-3" />
                  <label name="rating" htmlFor="rating-3" value={3} onClick={(e) => updateState('rate', parseInt(e.target.getAttribute("value")))}></label>
                  <input type="radio" name="rating" id="rating-2" />
                  <label name="rating" htmlFor="rating-2" value={2} onClick={(e) => updateState('rate', parseInt(e.target.getAttribute("value")))}></label>
                  <input type="radio" name="rating" id="rating-1" />
                  <label name="rating" htmlFor="rating-1" value={1} onClick={(e) => updateState('rate', parseInt(e.target.getAttribute("value")))}></label>
                  <span>Rating:</span>
                </div>
                <textarea placeholder='General feedback...' value={state.note} onChange={(e) => updateState('note', e.target.value)}></textarea>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="card-body">
                <div className="st-danhgianguphap ">
                  <div>
                    ...
                    /> */}
                    <textarea placeholder='Grammar feedback...' value={state.grammar} onChange={(e) => updateState('grammar', e.target.value)}></textarea>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card-body">
                <div className="st-danhgianguphap ">
                  <div>
                    ...
                    /> */}
                    <textarea placeholder='Vocabulary feedback...' value={state.vocabulary} onChange={(e) => updateState('vocabulary', e.target.value)}></textarea>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card-body">
                <div className="st-danhgianguphap ">
                  <div>
                    ...
                    /> */}
                    <textarea placeholder='Sentence feedback...' value={state.memorize} onChange={(e) => updateState('memorize', e.target.value)}></textarea>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="st-danhgianguphap ">
                  <div>
                    {/*  <TinyEditor options={{
                      ...
                      /> */}
                    <textarea placeholder='Pronounce feedback...' value={state.pronounce} onChange={(e) => updateState('pronounce', e.target.value)}></textarea>
                  </div>
                </div>
              </div>
            </div>
