  ...
  return (<>
    {
      state.loading ? <SkeletonLessonDetail /> : (
        <>
                    ...
                    <div className="infomation__wrap">
                      ...
                      <div className="st-time">
                        <p className="st-teacher-text">
                          ...
                          <span>Lesson name:</span> <span className="st-tengv tx-primary">{!!state.lessonInfo && !!state.lessonInfo.StudentName && state.lessonInfo.StudentName}</span>
                        </p>
                      </div>
                      <div className="st-time">
                ...
                <div className="col-md-6 col-sm-12">
                  ...
                  <div className="st-thangdanhgia">
                    ...
                    <div className="st-time">
                      <p className="st-teacher-text">
                      <i className="fa fa-user-graduate st-icon wd-20 mg-r-5"></i>
                        <span>Name: <span className="tx-primary">{!!state && !!state.studentName}</span></span>
                      </p>
                    </div>
                    <div className="st-time">

                    <p className="st-teacher-text">
                        <i className="fa fa-thumbs-up st-icon wd-20 mg-r-5"></i>
                        <span>Feedback: <span className="tx-primary">
                    ...
                    <div className="st-time">
                      <p className="st-teacher-text">
                        <i className="fa fa-comment st-icon wd-20 mg-r-5"></i>
                        <span>Evalution: <span className="tx-primary">{!!state && !!state.studentEvalution}</span></span>
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <h3 className="mg-y-30">Review</h3>
              ...
              <div className="review__wrap sec">
                ...
                <div className="st-danhgianguphap  mg-b-30">
                  <div className="st-title-danhgia mg-b-15">
                    <h5 className="mg-b-15">Vocabulary</h5>
                  </div>
                  <div>
                    <TinyEditor options={{
                      ...editorOptions,
                ...
                <div className="st-danhgianguphap  mg-b-30">
                  <div className="st-title-danhgia mg-b-15">
                    <h5 className="mg-b-15">Grammar</h5>
                  </div>
                  <div>
                    <TinyEditor options={{
                      ...editorOptions,
                ...
                <div className="st-danhgianguphap  mg-b-30">
                  <div className="st-title-danhgia mg-b-15">
                    <h5 className="mg-b-15">Pronounce</h5>
                  </div>
                  <div>
                    <TinyEditor options={{
                      ...editorOptions,
                ...
                <div className="st-danhgianguphap  mg-b-30">
                  <div className="st-title-danhgia mg-b-15">
                    <h5 className="mg-b-15">Sentence Development And Speak</h5>
                  </div>
                  <div>
                    <TinyEditor options={{
                      ...editorOptions,
                ...
                <div className="st-danhgianguphap  mg-b-30">
                  <div className="st-title-danhgia mg-b-15">
                    <h5 className="mg-b-15">General assessment</h5>
                  </div>
                  <div>
                    <TinyEditor options={{
                      ...editorOptions,
