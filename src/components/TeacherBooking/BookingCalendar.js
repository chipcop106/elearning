...
import {getListEventsOfWeek, setEventAvailable, cancelSchedule} from '~src/api/teacherAPI';
...
const bookingCalendar = () => {
    ...
    const fetchEvents = async () => {
        const res = await getListEventsOfWeek({Date:'11/07/2020'});
        if(res.Code === 1 && res.Data.lenght > 0) {
